...
class ContainerVC: UIViewController
{
    ...
    func initCenter(screen: ShowWhichVC)
    {
        ...
        if rootVC == nil
        {
            rootVC = UIStoryboard.rootVC()
            rootVC.delegate = self
        }
        
        presentingController = rootVC
...
extension ContainerVC: CenterVCDelegate
{
    ...
    @objc func animateLoginVC(shouldExpand: Bool)
    {
        if shouldExpand
        {
            isHidden = !isHidden
...
private extension UIStoryboard
{
    ...
    class func rootVC() -> RootVC
    {
        return (mainStoryBoard().instantiateViewController(withIdentifier: "RootVC") as? RootVC)!
    }
    ...
    class func onboardingVC() -> OnboardingOneVC
    {
        return (mainStoryBoard().instantiateViewController(withIdentifier: "OnboardingOneVC") as? OnboardingOneVC)!
    }
